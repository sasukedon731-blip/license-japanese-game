  ...
  return (
    <main style={styles.page}>
      <article style={styles.card}>
        ...
        <Section title="3. 外部サービス・委託">本サービスでは、認証・データ保存等のためFirebase、ホスティング等のためVercel、決済処理のため決済代行事業者その他の外部サービスを利用します。購入手続きに必要なメールアドレス、注文情報、決済状態等は、決済処理、入金確認、不正利用防止および問い合わせ対応に必要な範囲で決済代行事業者に送信または処理される場合があります。クレジットカード番号等は決済代行事業者が管理し、当社は原則として保持しません。当社は、利用目的の達成に必要な範囲で、これらの事業者に個人情報の取扱いを委託します。</Section>
